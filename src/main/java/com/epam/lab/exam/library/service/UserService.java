...
public class UserService {
    ...
    public UserDTO findByLogin(String username) throws ClientRequestException {
        return userRepository.findByLogin(username).map(UserDTO::from).orElseThrow(() -> ErrorType.USER_NOT_FOUND.ex());
    }
}
